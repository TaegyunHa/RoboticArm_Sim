%% Blended Straight line trajectory animation for task B3b2
% Taegyun Ha
...
Trajectory1 = Traj( EE_pos1, EE_pos3, sample_numbers1, 0.01, 0.002);
Trajectory7 = Traj_Blend_2( EE_pos3, EE_pos4, EE_pos5, EE_pos6, sample_numbers2, 0.01, 0.002);
...
for i = 1 : sample_numbers2
     temp_ar = [ Trajectory7(1,(1 + 4*(i-1))) Trajectory7(1,(2 + 4*(i-1))) Trajectory7(1,(3 + 4*(i-1))) Trajectory7(1,(4 + 4*(i-1))); 
                 Trajectory7(2,(1 + 4*(i-1))) Trajectory7(2,(2 + 4*(i-1))) Trajectory7(2,(3 + 4*(i-1))) Trajectory7(2,(4 + 4*(i-1))); 
                 Trajectory7(3,(1 + 4*(i-1))) Trajectory7(3,(2 + 4*(i-1))) Trajectory7(3,(3 + 4*(i-1))) Trajectory7(3,(4 + 4*(i-1))); 
                 0                  0                   0                  1                ];
     ar_pos = [ar_pos, IK(temp_ar)'];
end
